...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "hero.description": "Übernehmen Sie die Kontrolle über Ihre Impfunterlagen mit Spring Boosters. Verfolgen, verwalten und verpassen Sie nie wieder eine wichtige Auffrischungsimpfung.",
    ...
    "features.track.description": "Erfassen Sie alle Ihre Impfungen mit Daten und Notizen für eine vollständige Dokumentation.",
    "features.reminders.title": "Intelligente Erinnerungen",
    "features.reminders.description": "Erhalten Sie rechtzeitige Benachrichtigungen für anstehende Auffrischungen, damit Sie keine Dosis verpassen.",
    "features.status.title": "Statusübersicht",
    "features.status.description": "Dashboard zeigt auf einen Blick, welche Impfungen aktuell, bald fällig oder überfällig sind.",
    "features.database.title": "Impfdatenbank",
    "features.database.description": "Vorinstalliert mit gängigen Impfungen und deren empfohlenen Auffrischungsplänen.",
    
    // Footer
    "footer.copyright": "© 2025 Spring Boosters. Ihre Gesundheit, Ihre Daten, Ihre Kontrolle.",
    ...
    "auth.signin.description": "Geben Sie Ihre Anmeldedaten ein, um auf Ihr Konto zuzugreifen",
    ...
    "dashboard.delete.description": "Möchten Sie diese Impfung wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
    "dashboard.delete.cancel": "Abbrechen",
    "dashboard.delete.confirm": "Löschen",
    
    // Add vaccination dialog
    "addVaccination.title": "Impfung hinzufügen",
    "addVaccination.description": "Fügen Sie eine neue Impfung zu Ihren Unterlagen hinzu",
  ...
  en: {
    ...
    "hero.description": "Take control of your vaccination records with Spring Boosters. Track, manage, and never miss an important booster shot again.",
    "hero.getStarted": "Get Started",
    "hero.signUp": "Sign Up",
    
    // Features
    "features.title": "Everything You Need to Stay Protected",
    "features.subtitle": "Comprehensive vaccination management at your fingertips",
    "features.track.title": "Track Vaccinations",
    "features.track.description": "Record all your vaccinations with dates and notes for complete history tracking.",
    "features.reminders.title": "Smart Reminders",
    "features.reminders.description": "Get timely notifications for upcoming boosters so you never miss a dose.",
    "features.status.title": "Status Overview",
    "features.status.description": "Dashboard showing which vaccinations are current, due soon, or overdue at a glance.",
    "features.database.title": "Master Database",
    "features.database.description": "Pre-loaded with common vaccinations and their recommended booster schedules.",
    
    // Footer
    "footer.copyright": "© 2025 Spring Boosters. Your health, your data, your control.",
    ...
    "dashboard.delete.description": "Are you sure you want to delete this vaccination? This action cannot be undone.",
  ...
  fr: {
    ...
    "hero.description": "Prenez le contrôle de vos dossiers de vaccination avec Spring Boosters. Suivez, gérez et ne manquez plus jamais un rappel important.",
    ...
    "features.track.description": "Enregistrez toutes vos vaccinations avec dates et notes pour un suivi complet.",
    "features.reminders.title": "Rappels intelligents",
    "features.reminders.description": "Recevez des notifications pour les rappels à venir afin de ne jamais manquer une dose.",
    "features.status.title": "Aperçu du statut",
    "features.status.description": "Tableau de bord montrant quelles vaccinations sont à jour, bientôt dues ou en retard.",
    "features.database.title": "Base de données",
    "features.database.description": "Pré-chargé avec les vaccinations courantes et leurs calendriers de rappel recommandés.",
    
    // Footer
    "footer.copyright": "© 2025 Spring Boosters. Votre santé, vos données, votre contrôle.",
    ...
    "auth.signin.description": "Entrez vos identifiants pour accéder à votre compte",
    ...
    "dashboard.delete.description": "Êtes-vous sûr de vouloir supprimer cette vaccination ? Cette action est irréversible.",
    "dashboard.delete.cancel": "Annuler",
    "dashboard.delete.confirm": "Supprimer",
    
    // Add vaccination dialog
    "addVaccination.title": "Ajouter une vaccination",
    "addVaccination.description": "Ajoutez une nouvelle vaccination à vos dossiers",
